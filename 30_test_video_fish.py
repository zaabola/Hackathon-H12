...
# Load trained model
# -----------------------------
model = YOLO("C:/Users/zaabola/Desktop/PPE_Project/runs/detect/models/yolo/yolov8s_fish_finetuned/weights/best.pt")
...
output_path = "outputs/videos/fish_output.mp4"
...
while True:
    ...
    # Run YOLO
    results = model(frame ,imgsz=960, conf=0.4)
    result = results[0]
    boxes = result.boxes
