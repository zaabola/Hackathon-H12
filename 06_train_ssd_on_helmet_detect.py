...
def main():
    ...
    train_dataset = YOLODataset(
        "datasets/helmet_yolo_clean/train/images",
        "datasets/helmet_yolo_clean/train/labels"
    )

    val_dataset = YOLODataset(
        "datasets/helmet_yolo_clean/valid/images",
        "datasets/helmet_yolo_clean/valid/labels"
    )
    ...
    # Load SSD model
    # -----------------------------
    num_classes = 3  # background + hat + person
