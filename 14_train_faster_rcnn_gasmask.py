...
def main():
    ...
    torch.save(model.state_dict(), "models/faster_rcnn/faster_rcnn_gasmask_5epochs.pth")
    print("✅ Faster R-CNN gas mask model saved to models/faster_rcnn/faster_rcnn_gasmask_5epochs.pth")
